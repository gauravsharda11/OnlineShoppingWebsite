...
<body>
    ...
    <nav>
        <ul class=nav>
            ...
            <li><a class="navdata" href="index.php?op=112">Product Catalogue</a></li>
            <li><a class="navdata" href="index.php?op=51">List Users</a></li>
            ...
            if (isset($_SESSION['user_name'])) {
                ...
                echo'<li style="padding:10px; position:right;">'.$_SESSION['user_name'];
                echo '<img src=users_images/'.$_SESSION['user_pic'].'><li>';
            } else {
